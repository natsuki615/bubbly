...
async function preloadTracker() {
  // Temporarily silence console spam while MediaPipe initializes
  ...
  const vision = await FilesetResolver.forVisionTasks(
    // Pin to a version you know works for you:
    // "https://cdn.jsdelivr.net/npm/@mediapipe/tasks-vision@0.10.21/wasm"
    // This RC (release candidate) build also works; swap if you prefer:
